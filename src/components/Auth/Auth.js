    ...
    <>
      ...
      <div style={authContainerStyles}>
        <div style={{
          ...
          <Slide direction="right" in={tab === 'login'}>
            ...
            <div className={classes.paper}>
              ...
              <form className={classes.form} onSubmit={e => login({
                ...
                <Grid container>
                  ...
                  <Grid item>
                    <Link href="#" variant="body2" onClick={() => setTab('signup')}>
        ...
        <div style={{
          ...
          <Slide  direction="left" in={tab === 'signup'}>
          <Container component="main" maxWidth="xs">
            <CssBaseline />
            <div className={classes.paper}>
              <Avatar className={classes.avatar}>
              ...
              <form className={classes.form} onSubmit={e => signup({
                email: e.target.email.value,
                ...
                <Grid container>
                  ...
                  <Grid item>
                    <Link href="#" variant="body2" onClick={() => setTab('login')}>
